...
public class SearchFiltersActivity extends AppCompatActivity implements View.OnClickListener {
    TextView clearFilters,categoryWomen;
    LinearLayout categoryBaby, categoryKid, categoryMen;
    ...
    private void initAll() {
        ...
        categoryWomen = findViewById(R.id.casual);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            case R.id.cat_baby:
                ...
                break;
            case R.id.cat_kids:
                HomeFragment.category = "Hoodie";
                HomeFragment.isCategorySeleted = true;
                HomeFragment.isFiltersApplied = true;
                finish();
                break;
            case R.id.cat_men:
                HomeFragment.category = "Jean";
                HomeFragment.isCategorySeleted = true;
                HomeFragment.isFiltersApplied = true;
                finish();
                break;
            case R.id.casual:
                HomeFragment.category = "Casual";
                HomeFragment.isCategorySeleted = true;
                HomeFragment.isFiltersApplied = true;
                finish();
                break;
